    ...
    <div class="dashboard-container">
        ...
        <main>
            <div class="header-content">
                <h2>Gestao de Categorias</h2>
                <p>Visualize e gerencie as categorias do blog.</p>
                <a href="card-categorias.php" class="btn"><i class="fa-solid fa-plus"></i> Adicionar Novo</a>
            </div>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>01</td>
                            <td>Tecnologia</td>
                            <td>Artigos sobre tecnologia</td>
